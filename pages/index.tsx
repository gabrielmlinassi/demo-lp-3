                ...
                <div className="mt-4 sm:mt-12 space-y-4 sm:space-y-8 text-white leading-relaxed">
                  <div>
                    ...
                    <span className="font-bold">
                      true understanding of the learning and development work
                      you do.
                    </span>
                  </div>
                  <div>
                    SweetRush is an innovative and groundbreaking learning and
                    talent development solution provider with a 20-year track
                    record of effective solutions and happy clients. Our depth
                    of experience means we will quickly understand your specific
                    needs and find the right nuanced talent profile to fit those
                    needs.
                  </div>
                </div>
                <div className="w-1/2 sm:w-full ml-auto mt-4 sm:mt-8 text-white leading-relaxed">
                  <div>
                    SweetRush’s Talent Solutions team has one agenda: to source
                    and place great talent when our clients—like you—need to
                    augment their teams.
                  </div>
                </div>
              </div>
